...
public final class HttpUtil {
	...
	public static String post(String reqURL, String reqData, String contentType){
		...
		////比如MaxtTotal=400，DefaultMaxPerRoute=200，当只连接到https://jadyer.github.io/时，到该主机的并发最多只有200，而非400
		////而当连接https://jadyer.github.io/和http://blog.csdn.net/jadyer时，到每个主机的并发最多只有200，即加起来是400（但不能超过400）
