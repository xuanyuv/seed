...
public class JPATest {
    ...
    public void selectTest() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        //Assert.assertEquals("test22", scheduleTaskRepository.findTop3ByStatus(0, PageRequest.of(0, 10, new Sort(Sort.Direction.ASC, "id"))).getContent().get(0).getName());
        //Assert.assertEquals("test22", scheduleTaskRepository.queryFirst10ByStatus(0, PageRequest.of(0, 10, new Sort(Sort.Direction.ASC, "id"))).getContent().get(0).getName());
        //Assert.assertEquals("test44", scheduleTaskRepository.findTop10ByStatus(0, PageRequest.of(0, 10, new Sort(Sort.Direction.DESC, "id"))).get(1).getName());
