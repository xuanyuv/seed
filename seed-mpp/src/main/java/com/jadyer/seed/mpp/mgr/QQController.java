...
public class QQController extends QQMsgController {
	...
	protected QQOutMsg processInTextMsg(QQInTextMsg inTextMsg) {
		...
		//return new QQOutTextMsg(inTextMsg).setContent("言毕，二人竟瞬息不见，步法之神令人叹绝。欲知后事如何，请访问<a href=\"https://jadyer.github.io/\">我的博客</a>[阴险][阴险]");
	...
	protected QQOutMsg processInImageMsg(QQInImageMsg inImageMsg) {
		...
		//outMsg.addNews("点击访问我的博客", "第二个图文的描述", "http://img.my.csdn.net/uploads/201507/26/1437881866_3678.png", "https://jadyer.github.io/");
	...
	protected QQOutMsg processInFollowEventMsg(QQInFollowEventMsg inFollowEventMsg) {
		...
		if(QQInFollowEventMsg.EVENT_INFOLLOW_SUBSCRIBE.equals(inFollowEventMsg.getEvent())){
			...
			outMsg.addNews("欢迎关注", "更多精彩请访问我的博客", "http://img.my.csdn.net/uploads/201507/26/1437881866_3678.png", "https://jadyer.github.io/");
			return outMsg;
		}
	 ...
	 *     {"button":{"url":{"name":"test","type":"view","value":"https://github.com/jadyer/seed/"}},"data":{"keynote4":{"value":"通路无双"},"keynote3":{"value":"789"},"first":{"value":"天下无敌任我行"},"keynote2":{"value":"456"},"end":{"value":"随心所欲陪你玩"},"keynote1":{"value":"123"}},"templateid":"mytemplateid","tousername":"E12D231CFC30438FB6970B0C7669C101","type":"view","url":"https://jadyer.github.io/"}
	 * </p>
	 */
	@ResponseBody
	...
	public QQErrorInfo createQQMenu(String appid, String appsecret){
		QQTokenHolder.setQQAppidAppsecret(appid, appsecret);
		QQSubViewButton btn11 = new QQSubViewButton("我的博客", "https://jadyer.github.io/");
	...
	public QQErrorInfo pushQQMsgToFans(String appid, String appsecret, String openid){
		QQTokenHolder.setQQAppidAppsecret(appid, appsecret);
		////推图文消息
		//QQCustomNewsMsg.MPNews.Article article11 = new QQCustomNewsMsg.MPNews.Article("", "", "", "欢迎访问玄玉博客", "玄玉博客是一个开放态度的Java生态圈", "http://avatar.csdn.net/6/0/B/1_jadyer.jpg", "https://jadyer.github.io/");
