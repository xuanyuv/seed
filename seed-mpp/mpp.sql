...
)ENGINE=InnoDB DEFAULT CHARSET=UTF8 COMMENT='mpplus平台粉丝表';
...
)ENGINE=InnoDB DEFAULT CHARSET=UTF8 COMMENT='mpplus平台回复设置表';
...
create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间'
)ENGINE=InnoDB DEFAULT CHARSET=UTF8 COMMENT='mpplus平台自定义菜单表';
