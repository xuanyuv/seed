...
public class OpenConfiguration {
    ...
    public Filter openFilter(){
        ...
        list670.add(Constants.OPEN_METHOD_boot_file_upload);
        list670.add(Constants.OPEN_METHOD_boot_loan_submit);
        List<String> list770 = new ArrayList<>();
        list770.add(Constants.OPEN_METHOD_boot_file_upload);
        list770.add(Constants.OPEN_METHOD_boot_loan_submit);
        list770.add(Constants.OPEN_METHOD_boot_loan_get);
        List<String> list870 = new ArrayList<>();
        list870.add(Constants.OPEN_METHOD_boot_file_upload);
        list870.add(Constants.OPEN_METHOD_boot_loan_submit);
        list870.add(Constants.OPEN_METHOD_boot_loan_get);
        list870.add(Constants.OPEN_METHOD_boot_loan_agree);
        list870.add(Constants.OPEN_METHOD_boot_apidoc_h5);
        List<String> list970 = new ArrayList<>();
        list970.add(Constants.OPEN_METHOD_boot_loan_get);
